...
function peg$parse(input, options) {
  ...
  var peg$e14 = peg$classExpectation(["i"], false, false);
  ...
  function peg$parsedefinicion() {
    ...
    if (s1 !== peg$FAILED) {
      ...
      if (s4 !== peg$FAILED) {
        ...
        if (s6 !== peg$FAILED) {
          ...
          if (s10 !== peg$FAILED) {
            s11 = peg$parseespacio();
            s12 = peg$parseconstruccion();
            if (s12 !== peg$FAILED) {
              s9 = [s9, s10, s11, s12];
              s8 = s9;
            } else {
          ...
          s9 = peg$parseespacio_nueva_linea();
    ...
    if (s0 === peg$FAILED) {
      ...
      if (s1 !== peg$FAILED) {
        s2 = peg$parseespacio_nueva_linea();
        s1 = [s1, s2];
        s0 = s1;
      } else {
        peg$currPos = s0;
  ...
  function peg$parsesufijo() {
    ...
    if (s2 !== peg$FAILED) {
      s3 = peg$currPos;
      s4 = peg$parseespacio();
      s5 = peg$parseoperador_repeticion();
      if (s5 !== peg$FAILED) {
        s4 = [s4, s5];
        s3 = s4;
      } else {
